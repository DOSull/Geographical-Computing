...
26 Apr | [Random other stuff](labs/random-other-stuff/00-overview.ipynb) | [Random other stuff materials](labs/random-other-stuff/random-other-stuff.zip?raw=true)<br />Setting up working environments for the projects | [Videos](video-links.md#week-7-random-other-stuff-and-working-environments)
